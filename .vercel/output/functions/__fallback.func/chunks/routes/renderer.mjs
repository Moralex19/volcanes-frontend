...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"stylesheet","href":"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css"},{"rel":"icon","type":"image/png","href":"/logo.png"}],"style":[],"script":[],"noscript":[],"title":"Volcanes y Raíces"};
...
const entryFileName = "B0Bgd1Mz.js";
